                                ...
                                <table border="1px" class="table">
                                    ...
                                    @foreach($mesListOut as $mlo)
                                        <tr>
                                            ...
                                            <td>
                                                <span>{{ $logineduser->getMessagesOutQuantity($mlo->target_id) }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                                <p><b>Total outgoing messages: {{sizeof($logineduser->messageOut)}}</b></p>
                            </div>
                            <div class="table-responsive col-lg-6 col-md-6 col-sm-12">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($mesListIn as $mli)
                                        <tr>
                                            ...
                                            <td>
                                                <span>{{ $logineduser->getMessagesInQuantity($mli->author_id) }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                                <p><b>Total incoming messages: {{sizeof($logineduser->messageIn)}}</b></p>
                            </div>
